var GridEgreso={
    ...
    formatButton:function(cellvalue,options,rowObject){
        ...
        return '<button id="btn-changeStatus" id-egr="'+cellvalue+'"  type="button" class="btn-changeStatus btn btn-default" style="border:0px!important"><i class="fa fa-play"></i><span> Procesar</span></button>';
    },
